# init-composev3.ps1
# Generates docker-compose.yml with registry export dashboard and image cleanup
...
Write-Host "docker-compose.yml created with registry dashboard and cleanup service"
Write-Host "Access registry UI at http://localhost/registry-ui/"
Write-Host "Images older than 7 days in ./registry-export will be auto-deleted hourly"